...
<html>
			...
			<div class="container">
				<div id="menu">
                  ...
                  <ul>
                      ...
                      <li><a href="diem.php"><i class="fas fa-check"></i>ĐIỂM THI</a></li>
                      <li><a href="contact.php"><i class="fas fa-address-book"></i>Contact</a></li>
                  </ul>

              </div>
              <div class="cthome" style="margin-left: 120px;">
    ...
    if (isset($_POST['sua'])) {
        if (empty($_POST['ten']) or empty($_POST['ngaysinh']) or empty($_POST['sdt']) or empty($_POST['quequan'])) {echo '</br> <p style="color:red;font-weight:bold; "> vui lòng không để trống các trường!</p> </br>';} else {
            $id = $_GET['id'];
            $hotenSV = $_POST['ten'];
