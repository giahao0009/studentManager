...
if (isset($_SESSION['username'])) {
    $linkData = new mysqli('localhost', 'root', '', 'sinhvien') or die('kết nối thất bại');
    ...
    <body>
        ...
        <div class="body">
            <div class="container">
                <div id="menu">
                    <ul>
                        <li><a href="index.php" id="current"><i class="fas fa-home"></i>Trang chủ</a></li>
                        ...
                        <li><a href="lienhe.php"><i class="fas fa-address-book"></i>Liên hệ</a></li>
                    </ul>
                    <br>
                </div>
                <!-- Form lop -->
...
$query = 'SELECT * FROM lophoc';
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($r = mysqli_fetch_assoc($result)) {
            ...
            echo "<td style='text-align: center;'>
                    <a href='sualop.php?id=$idlop'><input id='btnSua' type='button' value='sửa' '></a>
                    <a href='xoalop.php?id=$idlop'><input id='btnXoa' type='button' value='xóa'></a>
                    <a href='dslop.php?id=$idlop'><input id='btnChitiet' type='button' value='xem danh sách' '></a>
                  </td>";
            echo '</tr>';
        }
    }
    ?>
                        ...
                        <form>
                            <a href="themlop.php"><input class="btn-add-class" width="100%" value="Thêm lớp" type="button" id="btnThemSV"></a>
                        </form>
                    </div>
                </div>
            </div>
