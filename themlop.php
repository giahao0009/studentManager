    ...
    <body>
        ...
        <div class="body">
			<div class="container">
              ...
              <div class="cthome main-ct" style="margin-left: 120px;">
				<h2>Thêm Lớp</h2>
...
$link = new mysqli('localhost', 'root', '', 'sinhvien') or die('kết nối thất bại ');
    ...
    if (isset($_POST['them'])) {
        if (empty($_POST['ten']) or empty($_POST['GVCN']) or empty($_POST['phonghoc'])) {echo '</br> <p style="color:red; "> Bạn chưa nhập thông tin đầy đủ ! </p> </br>';} else {
            $lop = $_POST['ten'];
